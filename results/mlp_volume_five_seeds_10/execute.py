...
os.environ['MLP10_VOLUME_OUT']=str(Path('outputs/mlp_volume_five_seeds_10').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_volume_five_seeds_10/start_cell.txt').read_text()):]:
