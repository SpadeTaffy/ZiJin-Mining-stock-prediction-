...
os.environ['MLP15_PX_OUT']=str(Path('outputs/variable_focus_2017_15').resolve())
...
for cell in n.cells[int(Path("outputs/variable_focus_2017_15/start_cell.txt").read_text()):]:
...
print('2017 focus chart complete.')
