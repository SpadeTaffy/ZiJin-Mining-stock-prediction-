...
os.environ['MLP11_EPOCH_OUT']=str(Path('outputs/mlp_stacking_epochs_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_stacking_epochs_11/start_cell.txt').read_text()):]:
...
print(scope['comparison_e'].to_string()); print(scope['summary_e'].to_string())
