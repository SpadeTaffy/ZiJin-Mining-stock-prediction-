...
os.environ['MLP11_DEFINITION_OUT']=str(Path('outputs/mlp_direct_definition_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_direct_definition_11/start_cell.txt').read_text()):]:
...
print(scope['annual_mean'].to_string()); print(scope['summary_def'].to_string())
