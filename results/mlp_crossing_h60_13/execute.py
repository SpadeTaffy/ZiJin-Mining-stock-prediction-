...
os.environ['MLP13_CROSS60_OUT']=str(Path('outputs/mlp_crossing_h60_13').resolve())
...
for cell in n.cells[int(Path("outputs/mlp_crossing_h60_13/start_cell.txt").read_text()):]:
