...
os.environ['MLP14_PX_OUT']=str(Path('outputs/all_variables_plotly_2016_14').resolve())
...
for cell in n.cells[int(Path("outputs/all_variables_plotly_2016_14/start_cell.txt").read_text()):]:
