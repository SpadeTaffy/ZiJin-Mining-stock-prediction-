...
os.environ['MLP11_TEN_MA_OUT']=str(Path('outputs/mlp_ten_seeds_ma_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_ten_seeds_ma_11/start_cell.txt').read_text()):]:
