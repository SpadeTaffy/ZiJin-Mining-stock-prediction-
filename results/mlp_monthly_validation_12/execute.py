...
os.environ['MLP12_OUT']=str(Path('outputs/mlp_monthly_validation_12').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_monthly_validation_12/start_cell.txt').read_text()):]:
