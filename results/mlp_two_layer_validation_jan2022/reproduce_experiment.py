...
OUT = PROJECT_ROOT / 'results/mlp_two_layer_validation_jan2022'
OUT.mkdir(parents=True, exist_ok=True)
SEED, LR = 42, 0.01
HIDDEN_LAYERS = (16, 32)
MAX_EPOCHS, PATIENCE, MIN_DELTA = 2000, 100, 1e-6
TEST_START = pd.Timestamp('2022-02-01')
...
assert X_val.index.min() >= VAL_START
...
ax.set(xlabel='Epoch', ylabel='MSE (standardized target)', title='Refit on all records before February 2022')
ax.grid(alpha=0.2)
ax.legend()
fig.tight_layout()
