...
os.environ['MLP12_PX_OUT']=str(Path('outputs/price_metal_plotly_12').resolve())
...
for cell in n.cells[int(Path('outputs/price_metal_plotly_12/start_cell.txt').read_text()):]:
