...
os.environ['MLP14_ANNUAL_MULTI_OUT']=str(Path('outputs/multi_threshold_annual_14').resolve())
...
for cell in n.cells[int(Path("outputs/multi_threshold_annual_14/start_cell.txt").read_text()):]:
