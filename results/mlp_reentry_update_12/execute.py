...
os.environ['MLP12_REENTRY_OUT']=str(Path('outputs/mlp_reentry_update_12').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_reentry_update_12/start_cell.txt').read_text()):]:
