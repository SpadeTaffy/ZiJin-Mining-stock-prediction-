...
os.environ['MLP14_COMBINED_PLOTS_OUT']=str(Path('outputs/rsi_macd_combined_plots_14').resolve())
...
for cell in n.cells[int(Path("outputs/rsi_macd_combined_plots_14/start_cell.txt").read_text()):]:
