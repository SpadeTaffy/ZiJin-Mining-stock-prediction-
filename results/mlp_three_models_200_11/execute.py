...
os.environ['MLP11_THREE_OUT']=str(Path('outputs/mlp_three_models_200_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_three_models_200_11/start_cell.txt').read_text()):]:
...
print(scope['test_mape3'].to_string()); print(scope['summary3'].to_string())
