...
os.environ['MLP10_ANNUAL_OUT']=str(Path('outputs/mlp_annual_three_models_10').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_annual_three_models_10/start_cell.txt').read_text()):]:
...
nbformat.write(n,p)
print(scope['annual'].to_string());print(scope['summary'].to_string(index=False))
