...
n.cells.append(nb.v4.new_markdown_cell('''# 双向触发＋半衰期60：2015—2026逐年预测图
...
s=Path('outputs/mlp_half_life_comparison_13/execute.py').read_text().replace('MLP13_GRID_OUT','MLP13_ANNUAL_PLOTS_OUT').replace('mlp_half_life_comparison_13','mlp_crossing_h60_annual_plots_13').replace("print(scope['monthly'].to_string()); print(scope['summary'].to_string(index=False))","print('Annual prediction charts complete.')")
