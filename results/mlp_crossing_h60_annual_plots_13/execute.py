...
os.environ['MLP13_ANNUAL_PLOTS_OUT']=str(Path('outputs/mlp_crossing_h60_annual_plots_13').resolve())
...
for cell in n.cells[int(Path("outputs/mlp_crossing_h60_annual_plots_13/start_cell.txt").read_text()):]:
...
print('Annual prediction charts complete.')
