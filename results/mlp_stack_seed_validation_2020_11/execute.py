...
os.environ['MLP11_STACK_SEEDVAL_OUT']=str(Path('outputs/mlp_stack_seed_validation_2020_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_stack_seed_validation_2020_11/start_cell.txt').read_text()):]:
...
print(scope['comparison'].to_string()); print(scope['result'])
