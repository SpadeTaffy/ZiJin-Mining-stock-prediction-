...
os.environ['MLP11_SEEDVAL_OUT']=str(Path('outputs/mlp_seed_validation_2020_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_seed_validation_2020_11/start_cell.txt').read_text()):]:
