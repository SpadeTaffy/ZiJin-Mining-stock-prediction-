...
os.environ['MLP11_ANNUAL_MA_OUT']=str(Path('outputs/mlp_annual_ten_ma_11').resolve())
...
for cell in n.cells[int(Path('outputs/mlp_annual_ten_ma_11/start_cell.txt').read_text()):]:
...
print(scope['annual_mean'].to_string()); print(scope['annual_summary'].to_string())
