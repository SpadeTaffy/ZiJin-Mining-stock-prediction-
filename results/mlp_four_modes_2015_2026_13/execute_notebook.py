...
os.environ['MLP13_FOUR_OUT']=str(Path('outputs/mlp_four_modes_2015_2026_13').resolve())
...
for cell in n.cells[int(Path("outputs/mlp_four_modes_2015_2026_13/start_cell.txt").read_text()):]:
