...
os.environ['MLP14_RSI_MACD_OUT']=str(Path('outputs/rsi_macd_annual_14').resolve())
...
for cell in n.cells[int(Path("outputs/rsi_macd_annual_14/start_cell.txt").read_text()):]:
